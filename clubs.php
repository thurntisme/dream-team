...
<head>
    ...
    <title>Other Clubs - Dream Team</title>
    ...
    <nav class="bg-white shadow">
        <div class="container mx-auto p-4 max-w-6xl flex justify-between items-center">
            <div class="flex items-center gap-4">
                <a href="team.php" class="flex items-center">
                ...
                <nav class="hidden md:flex items-center gap-4 ml-8">
                    <a href="team.php" class="text-gray-600 hover:text-blue-600 flex items-center gap-1">
                        <i data-lucide="users" class="w-4 h-4"></i>
                        My Team
                    </a>
                    <a href="clubs.php" class="text-blue-600 font-semibold flex items-center gap-1">
                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-3 mb-4">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span
                                        class="text-sm font-semibold"><?php echo htmlspecialchars($club['formation']); ?></span>
                                </div>
